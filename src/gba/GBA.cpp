...
bool CPUWriteBatteryFile(const char *fileName)
{
  if(gbaSaveType == 0) {
    ...
    cout << "gbaSaveType " << gbaSaveType << endl;
  ...
  for(;;) {
    ...
    updateLoop:
      ...
      lcdTicks -= clockTicks;
        ...
        //cout << "lcdTicks is " << lcdTicks << " " << DISPSTAT << endl;
      if(lcdTicks <= 0) {
        if(DISPSTAT & 1) { // V-BLANK
          ...
          if(DISPSTAT & 2) {
            ...
            CPUCompareVCOUNT();
              ...
              //cout << "frameCount " << frameCount << " " << framesToSkip << endl;
            if(frameCount >= framesToSkip)
            {
              (*renderLine)();
                //cout <<"systemColorDepth is "<< systemColorDepth << endl;
              switch(systemColorDepth) {
                ...
                case 32:
                {
                  ...
                  for(int x = 0; x < 240; ) {
//                      cout << "set " << lineMix[x] << " " << systemColorMap32[lineMix[x] & 0xffff] << " to dest" << endl;
